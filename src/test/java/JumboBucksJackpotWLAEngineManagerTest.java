...
public class JumboBucksJackpotWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(JumboBucksJackpotWLAEngineManagerTest.class);
		logger.setLevel(Level.DEBUG);
		gameParams = XMLUtil.parseResource("paymodel/JumboBucksJackpotWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/JumboBucksJackpotWLAIW/InitOutcome.xml").getDocumentElement();
